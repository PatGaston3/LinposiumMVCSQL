...
//				String employer = tokens[1];
//				String location = tokens[2];
//				String title = tokens[3];
//				String specialty = tokens[4];
//				String datePosted = tokens[5];
//				String deadline = tokens[6];
//				String website = tokens[7];
//				jobs.add(new Job(id, employer, location, title, specialty, deadline, datePosted, website));
//			}
//		} catch (Exception e) {
